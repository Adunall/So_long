...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/12 15:19:24 by adunal            #+#    #+#             */
/*   Updated: 2023/06/18 18:25:23 by adunal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	image_create(t_data *data)
{
	...
	data->img.wall = mlx_xpm_file_to_image(data->mlx, "img/bacgraund.xpm",
			&data->img.img_w, &data->img.img_h);
	data->img.door = mlx_xpm_file_to_image(data->mlx, "img/tutsak.xpm",
			&data->img.img_w, &data->img.img_h);
	data->img.door_open = mlx_xpm_file_to_image(data->mlx, "img/kurtulmus.xpm",
			&data->img.img_w, &data->img.img_h);
